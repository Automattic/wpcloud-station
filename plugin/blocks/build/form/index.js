...
function Edit({
  ...
  const isChildSelected = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_4__.useSelect)(select => select('core/block-editor').hasSelectedInnerBlock(clientId));
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useInnerBlocksProps)(blockProps, {
    allowedBlocks: ['core/paragraph', 'core/heading', 'wpcloud/form-input', 'wpcloud/form-submit-button'],
    templateLock: false,
    renderAppender: isSelected || isChildSelected ? _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks.ButtonBlockAppender : undefined
  });
