...
error_log($fields);
$fields .= '<input type="hidden" name="action" value="wpcloud_block_form_submit" />';
if ( isset( $attributes['wpcloud-action'] ) ) {
	$fields .= '<input type="hidden" name="wpcloud-form-action" value="' . esc_attr( $attributes[ 'wpcloud-form-action' ] ) . '" />';
}
