 ...
 */
import { useLegendTooltip } from '@wpcloud/metrics/components/contexts';
...
export default function SummaryGraph({
	...
	const { show: showTooltip, hide: hideTooltip } = useLegendTooltip();
				...
				return (
					...
					>
						<div
							...
							onMouseEnter={(e) => showTooltip( s.label || `Series ${i + 1}`, e)}
